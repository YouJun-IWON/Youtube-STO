    ...
    <section className='bg-white  '>
      <div className='py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 relative'>
        <div
          ...
          className='inline-flex justify-between items-center py-1 px-1 pr-4 mb-7 text-sm text-red-700 bg-red-100 rounded-full dark:bg-red-900 dark:text-red-300 hover:bg-red-200 '
        >
